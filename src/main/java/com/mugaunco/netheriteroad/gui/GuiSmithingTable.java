...
public class GuiSmithingTable{
	...
	public static class GuiWindow extends GuiContainer {
		...
		public GuiWindow(World world, int x, int y, int z, EntityPlayer entity) {
			super(new ContainerSmithing(world,new BlockPos(x,y,z),entity));
			this.world = world;
			this.x = x;
			this.y = y;
			this.z = z;
		...
		private static final ResourceLocation texture = new ResourceLocation("netheriteroad:textures/smithing.png");
		@Override
		...
		protected void actionPerformed(GuiButton button) {
			NetheriteRoad.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
